 ...
 */
export function NowPlaying({ book, player, chapterCount, marked, onExit, onRibbon, onQuote }: Props) {
  return (
    <div className="folio-view">
      ...
      <Transport player={player} disabled={false} marked={marked} onRibbon={onRibbon} onQuote={onQuote} />
    </div>
  )
}
